                      ...
                      >
                        <h3 className="text-xl font-bold text-[#0F172A] dark:text-white mb-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {[
                              { id: "sims", label: "MindSync SIMS", desc: "School Management System", icon: GraduationCap },
                              { id: "lms", label: "MindSync LMS", desc: "Learning System & coursework", icon: Layout },
                              { id: "coach", label: "MindSync Coach", desc: "AI classroom suite & lesson plans", icon: BookOpen },
                              { id: "sport", label: "MindSync Sport", desc: "Athletic operations & meets", icon: Trophy },
                              { id: "tutorsmart", label: "TutorSmart", desc: "One-to-one professional tutoring", icon: Users },
                              { id: "coursify", label: "Coursify", desc: "Convert files & videos to courses", icon: Zap },
                              { id: "magazine", label: "MindSync Magazine", desc: "Parent newsletters & calendars", icon: Share2 },
                              { id: "jobs", label: "MindSync Jobs", desc: "Substitute teacher staffing", icon: Bot },
                              { id: "custom", label: "Custom Integration", desc: "Connect data to custom systems", icon: Code },
                              { id: "general", label: "General Enquiry", desc: "Other questions or support", icon: HelpCircle },
                            ].map((item) => {
                              ...
                              return (
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    let templateText = "";
                                    if (item.id === "sims") templateText = "I'm looking to implement MindSync SIMS for our school. ";
                                    if (item.id === "lms") templateText = "I'm looking to set up MindSync LMS for our institution. ";
                                    if (item.id === "coach") templateText = "I'm interested in implementing MindSync Coach for lesson planning, grading rubrics, and classroom bots. ";
                                    if (item.id === "sport") templateText = "I'm interested in setting up MindSync Sport for athletic operations, meets, and brackets. ";
                                    if (item.id === "tutorsmart") templateText = "I'd like to learn more about TutorSmart tutoring solutions for our students. ";
                                    if (item.id === "coursify") templateText = "I'm interested in using Coursify to convert static materials into LMS-compatible courses. ";
                                    if (item.id === "magazine") templateText = "I'd like details on setting up MindSync Magazine for parent communications and newsletters. ";
                                ...
                                <div>
                                  <h4 className="font-bold text-[#0F172A] dark:text-white text-sm">{item.label}</h4>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              <Label htmlFor="organization" className="text-slate-700 dark:text-slate-300 font-semibold">
                                Organization / School Name
                              </Label>
                              <button
                                type="button"
                                onClick={() => setFormData(prev => ({ ...prev, organization: "Anonymous" }))}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1">
                              {["Principal", "Administrator", "IT Director", "Teacher", "Other"].map((roleOption) => (
                                <button
                                  key={roleOption}
                                  type="button"
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-slate-500 dark:text-slate-400">
                            Provide details or select the quick contact option below.
                          </p>
                        </div>
                        ...
                        <div className="flex gap-2">
                          <button
                            type="button"
                            onClick={() => setFormData(prev => ({ ...prev, message: "No message, please just reach out to me directly." }))}
                            className={`px-4 py-2 rounded-xl text-xs font-semibold border transition-all ${
                              formData.message === "No message, please just reach out to me directly."
                                ? "bg-indigo-600 text-white border-indigo-600 dark:bg-indigo-500 dark:border-indigo-500"
                                : "bg-slate-50 border-slate-200 text-slate-600 dark:bg-white/5 dark:border-white/10 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10"
                            }`}
                          >
        ...
        <div className="max-w-6xl mx-auto border-t border-slate-200 dark:border-white/5 pt-16 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium">
              Want to skip the form? Reach out directly via our regional lines.
            </p>
          </div>
