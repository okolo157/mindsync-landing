...
function MetricCard({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-white/8 bg-white/5 dark:bg-black/20 backdrop-blur-md p-5"
    >
      ...
      <main className="relative z-10 px-4 pb-24 pt-28">
        <div className="mx-auto max-w-3xl">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-white/10 dark:border-white/6 bg-white/70 dark:bg-white/4 backdrop-blur-xl shadow-2xl shadow-black/10 dark:shadow-black/40"
          >
            {/* Card inner glow */}
              ...
              <div className="flex justify-center gap-3">
                {!isRunning ? (
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex items-center gap-2 rounded-2xl border border-white/15 bg-white/6 px-8 py-4 text-sm font-bold text-muted-foreground backdrop-blur-md transition-colors hover:text-foreground"
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 px-1">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handleCopy}
                      className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-semibold text-muted-foreground transition-colors hover:text-foreground"
                    >
                      {copied ? (
                        <>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-white/8 bg-white/5 dark:bg-black/15 backdrop-blur-md p-5"
                >
                        ...
                        <div
                          ...
                          className={cn(
                            ...
                            ok
                              ...
                              : 'bg-white/4 ring-1 ring-white/5 opacity-60',
                          )}
                        >
                          <div
                            className={cn(
                              'mt-0.5 rounded-lg p-1.5',
                              ok ? 'bg-emerald-500/15 text-emerald-400' : 'bg-white/8 text-muted-foreground',
                            )}
                          >
          ...
          {history.length > 0 && (
            <motion.div
              ...
              className="mt-6 rounded-2xl border border-white/8 bg-white/5 dark:bg-black/15 backdrop-blur-md overflow-hidden"
            >
              {/* Header */}
              <button
                onClick={() => setShowHistory(v => !v)}
                className="flex w-full items-center justify-between px-5 py-4 text-sm font-bold text-foreground hover:bg-white/3 transition-colors"
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded-lg px-2.5 py-1 text-xs font-semibold text-muted-foreground hover:text-foreground border border-white/8 hover:bg-white/5 transition-colors"
                  >
                    JSON
                  </button>
                  <button
