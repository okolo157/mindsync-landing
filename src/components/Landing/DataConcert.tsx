          ...
          <div className="space-y-8">
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
                We understand that the core of a school is data. That's why our value add is letting your data work in concert with any system in the MindSync ecosystem or a custom product.
              </p>
            </div>
          ...
          <div className="relative flex items-center justify-center min-h-[400px] sm:min-h-[500px]">
            ...
            <div className="relative w-full max-w-[450px] aspect-square flex items-center justify-center">
              ...
              <motion.div 
                ...
                className="absolute z-10 w-24 h-24 rounded-full bg-gradient-to-br from-slate-900 to-indigo-950 dark:from-slate-950 dark:to-indigo-950 flex flex-col items-center justify-center border border-indigo-500/30 shadow-[0_20px_50px_rgba(99,102,241,0.2)] text-white text-center p-2 cursor-pointer"
              >
